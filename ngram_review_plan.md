...
| In Progress | Gate | Correctness and bounded-resource targets | 19D/19E/19H/19I regressions, memory-peak evidence, format-4/5 fixtures and the crash script landed 2026-09-08 (see the repair evidence row). Missing: current-head sanitizer and Correctness CI results on the pushed branch, and the same-gram-size collision seam of 19A. |
