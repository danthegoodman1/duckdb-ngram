...
- Engine commit: `bb298db62399`; build commit: `be1880cc5c83`; DuckDB v2.0.0 / source e366461e;
...
- Timed load—fresh CLI and absent DB through create, hex decode, insert, CHECKPOINT—was
  4.774 s median (4.056–5.223 s). Timed index build—fresh CLI through create-index and
  CHECKPOINT—was 7.299 s median (7.185–7.331 s), 128.94 MiB/s of source text.
...
- Build-process max RSS: 8.253 GiB median. Sampled peak temp apparent file bytes: 0.000 GiB
...
| moderate | index | 26,068 | 26,381 | 8 / 12 ms / 6–12 ms | 35 / 36 ms / 34–37 ms | 4.38× |
| dense | full-scan-fallback | 1,963,067 | 1,963,067 | 51 / 55 ms / 50–60 ms | 49 / 50 ms / 47–51 ms | 0.96× |
