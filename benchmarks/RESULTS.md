...
- Engine commit: `9eff4f026ced`; build commit: `cd2a0af0e2ea`; DuckDB v2.0.0 / source e366461e;
...
- Timed load—fresh CLI and absent DB through create, hex decode, insert, CHECKPOINT—was
  5.130 s median (4.774–5.212 s). Timed index build—fresh CLI through create-index and
  CHECKPOINT—was 7.256 s median (7.204–7.302 s), 129.70 MiB/s of source text.
...
- Build-process max RSS: 8.292 GiB median. Sampled peak temp apparent file bytes: 0.000 GiB
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| rare | index | 1 | 12 | 2 / 3 ms / 2–3 ms | 54 / 56 ms / 53–58 ms | 27.00× |
| moderate | index | 26,068 | 26,381 | 7 / 10 ms / 6–11 ms | 35 / 38 ms / 34–38 ms | 5.00× |
| dense | full-scan-fallback | 1,963,067 | 1,963,067 | 51 / 53 ms / 49–55 ms | 49 / 51 ms / 47–52 ms | 0.96× |
